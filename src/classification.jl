function total_population(y_true, y_pred)
    @_dimcheck size(y_true) == size(y_pred)
    return(length(y_true))
end

function true_positive(y_true, y_pred)
    @_dimcheck size(y_true) == size(y_pred)
    return(sum((y_true .== y_pred) & (y_true .== 1)))
end

function true_negative(y_true, y_pred)
    @_dimcheck size(y_true) == size(y_pred)
    return(sum((y_true .== y_pred) & (y_true .== 0)))
end

function false_positive(y_true, y_pred)
    @_dimcheck size(y_true) == size(y_pred)
    return(sum(!(y_true .== y_pred) & (y_true .== 1)))
end

function false_negative(y_true, y_pred)
    @_dimcheck size(y_true) == size(y_pred)
    return(sum(!(y_true .== y_pred) & (y_true .== 0)))
end

function condition_positive(y_true, y_pred)
    @_dimcheck size(y_true) == size(y_pred)
    return(sum(y_true .== 1))
end

function condition_negative(y_true, y_pred)
    @_dimcheck size(y_true) == size(y_pred)
    return(sum(y_true .== 0))
end

function predicted_condition_positive(y_true, y_pred)
    @_dimcheck size(y_true) == size(y_pred)
    return(sum(y_true .== 1))
end

function predicted_condition_negative(y_true, y_pred)
    @_dimcheck size(y_true) == size(y_pred)
    return(sum(y_pred .== 0))
end
...
function prevalence(y_true, y_pred)
    @_dimcheck size(y_true) == size(y_pred)
...
function Base.precision(y_true, y_pred)
    @_dimcheck size(y_true) == size(y_pred)
    tp = true_positive(y_true, y_pred)
...
function positive_likelihood_ratio(y_true, y_pred)
    @_dimcheck size(y_true) == size(y_pred)
...
function negative_likelihood_ratio(y_true, y_pred)
    @_dimcheck size(y_true) == size(y_pred)
...
function diagnostic_odds_ratio(y_true, y_pred)
    @_dimcheck size(y_true) == size(y_pred)
...
function matthews_corrcoef(y_true, y_pred)
    @_dimcheck size(y_true) == size(y_pred)
    tp = true_positive(y_true, y_pred)
    tn = true_negative(y_true, y_pred)
    fp = false_positive(y_true, y_pred)
